...
cp -f ~/Vector4D.Argus/Argus.Calibration/bin/Debug/net5.0/CalibrationResults/right_arm.xml ~/RJ1300_Stereo/Arrester/right_arm.xml
cp -f ~/Vector4D.Argus/Argus.Calibration/bin/Debug/net5.0/CalibrationResults/right_arm.xml ~/RJ1300_Stereo/Cable/right_arm.xml
